...
declare global {
  ...
  interface HTMLCounterButtonElement extends Components.CounterButton, HTMLStencilElement {
    addEventListener<K extends keyof HTMLCounterButtonElementEventMap>(
      type: K,
      listener: (this: HTMLCounterButtonElement, ev: CounterButtonCustomEvent<HTMLCounterButtonElementEventMap[K]>) => any,
    ...
    removeEventListener<K extends keyof HTMLCounterButtonElementEventMap>(
      type: K,
      listener: (this: HTMLCounterButtonElement, ev: CounterButtonCustomEvent<HTMLCounterButtonElementEventMap[K]>) => any,
